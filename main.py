...
user=Application("leena@gmail.com","leena","8999725871","dubai","1234") #aredy registerd user
...
while temp3 :
    ...
    if inp == 1:
       ...
       if ad.admin_keys[username] == password:
        ...
        while temp3:
            admin_input = int(input("Choose the options of admin panel 1.ADD NEW ITEM  2.EDIT ITEM  3.VIEW ITEM LIST 4.REMOVE ITEM 5.EXIT"))
            if admin_input == 1:
                ad.add_new_item()
            elif admin_input == 2:
                ad.edit_from_item()
